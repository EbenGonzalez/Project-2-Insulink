...
const { getOwnInsulin, getInsulin, getOwnRatio, getRatio, getOwnResistance,getResistance, getOwnCh, getCh, getOwnTime, getTime} =require ("../controllers/utilities.controller")
...
router.get('/time/me', checkAuth, getOwnTime )
router.get('/time/:id', checkAuth, checkDoctor, getTime)
