...
async function getOwnObjetive(req, res) {
    try {
        ...
        if (user) {
            ...
            if(media>=70){
                 res.status(200).sendFile("/home/roberto/code/labs/Proyecto-2-API-REST/public/images/111.png")
                 
                }else if(media>=50){
                    return res.status(200).sendFile("/home/roberto/code/labs/Proyecto-2-API-REST/public/images/222.png")
                }else{
                    return res.status(200).sendFile("/home/roberto/code/labs/Proyecto-2-API-REST/public/images/333.png")
                }
        } else {
