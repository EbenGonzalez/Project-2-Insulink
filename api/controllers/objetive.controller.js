...
async function getOwnObjetive(req, res) {
    try {
        ...
        if (user) {
            ...
            if(media>=70){
                 res.status(200).sendFile("/home/roberto/code/labs/Proyecto-2-API-REST/public/images/bien.png")
                 
                }else if(media>=50){
                    return res.status(200).sendFile("/home/roberto/code/labs/Proyecto-2-API-REST/public/images/medio.png")
                }else{
                    return res.status(200).sendFile("/home/roberto/code/labs/Proyecto-2-API-REST/public/images/mal.png")
                }
        } else {
